...
import (
	...
	"github.com/ruijzhan/helm/v3/pkg/kube"
...
func TestCheckOwnership(t *testing.T) {
	...
	assert.EqualError(t, err, `invalid ownership metadata; label validation error: missing key "app.kubernetes.io/managed-by": must be set to "Helm"; annotation validation error: missing key "meta.github.com/ruijzhan/release-name": must be set to "rel-a"; annotation validation error: missing key "meta.github.com/ruijzhan/release-namespace": must be set to "ns-a"`)
	...
	err = checkOwnership(deployFoo.Object, "rel-a", "ns-a")
	assert.EqualError(t, err, `invalid ownership metadata; annotation validation error: missing key "meta.github.com/ruijzhan/release-name": must be set to "rel-a"; annotation validation error: missing key "meta.github.com/ruijzhan/release-namespace": must be set to "ns-a"`)
	...
	err = checkOwnership(deployFoo.Object, "rel-a", "ns-a")
	assert.EqualError(t, err, `invalid ownership metadata; annotation validation error: missing key "meta.github.com/ruijzhan/release-namespace": must be set to "ns-a"`)
	...
	assert.EqualError(t, err, `invalid ownership metadata; annotation validation error: key "meta.github.com/ruijzhan/release-name" must equal "rel-b": current value is "rel-a"`)

	// Verify ownership error for wrong release namespace
	err = checkOwnership(deployFoo.Object, "rel-a", "ns-b")
	assert.EqualError(t, err, `invalid ownership metadata; annotation validation error: key "meta.github.com/ruijzhan/release-namespace" must equal "ns-b": current value is "ns-a"`)
