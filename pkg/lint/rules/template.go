...
import (
	...
	"github.com/ruijzhan/helm/v3/pkg/engine"
	"github.com/ruijzhan/helm/v3/pkg/lint/support"
)
...
func validateListAnnotations(yamlStruct *K8sYamlStruct, manifest string) error {
	if yamlStruct.Kind == "List" {
		...
		for _, i := range m.Items {
			if _, ok := i.Metadata.Annotations["github.com/ruijzhan/resource-policy"]; ok {
				return errors.New("Annotation 'github.com/ruijzhan/resource-policy' within List objects are ignored")
			}
		}
	}
	return nil
